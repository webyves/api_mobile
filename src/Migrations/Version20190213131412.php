 ...
 */
final class Version20190213131412 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client_user ADD client_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5C0F152B19EB6921 ON client_user');
        $this->addSql('ALTER TABLE client_user DROP client_id');
    }
}
